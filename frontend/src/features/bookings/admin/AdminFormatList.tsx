  ...
  return (
    <div>
      ...
      <ConfirmModal
        open={deleteId !== null}
        title="Delete Format"
        message="Are you sure you want to delete this format? This will deactivate it. Active formats assigned to showtimes will not be affected."
        confirmLabel="Delete"
        cancelLabel="Cancel"
        isPending={deleteMutation.isPending}
        error={
          deleteMutation.error
            ? (deleteMutation.error as { response?: { data?: { detail?: string } } })?.response?.data?.detail || "Failed to delete format."
            : null
        }
