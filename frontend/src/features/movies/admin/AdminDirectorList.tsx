...
import {
  fetchAdminDirectors,
  deleteDirector,
} from "@/features/movies/api/directors.api";
  ...
  return (
    <div>
      ...
      <ConfirmModal
        ...
        message="Are you sure you want to delete this director? The director will be deactivated and hidden from the public catalog."
        confirmLabel="Delete"
        cancelLabel="Cancel"
        isPending={deleteMutation.isPending}
        error={
          deleteMutation.error
            ? (deleteMutation.error as { response?: { data?: { detail?: string } } })?.response?.data?.detail || "Failed to delete director."
            : null
        }
