...
import { fetchAdminMovies, deleteMovie } from "@/features/movies/api/movies.api";
import type { MovieList } from "@/features/movies/types/movie.types";
  ...
  return (
    <div>
      ...
      <ConfirmModal
        open={deleteId !== null}
        title="Delete Movie"
        message="This will deactivate the movie. It will no longer appear on the home page but can be reactivated later."
