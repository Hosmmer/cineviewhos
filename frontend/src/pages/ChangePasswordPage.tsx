    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-900 px-4 relative overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <form onSubmit={formik.handleSubmit} className="bg-gray-800/80 backdrop-blur-sm rounded-xl border border-gray-700/50 p-6 sm:p-8 space-y-5 shadow-2xl">
          <h1 className="text-xl font-bold text-white text-center">Cambiar Contrasena</h1>

          <div>
            <label htmlFor="current_password" className="block text-sm font-medium text-gray-300 mb-1.5">Contrasena Actual</label>
            <input
              id="current_password"
            ...
            {formik.touched.current_password && formik.errors.current_password && (
              <p className="text-red-400 text-xs mt-1">{formik.errors.current_password}</p>
            )}
          </div>

          <div>
            <label htmlFor="new_password" className="block text-sm font-medium text-gray-300 mb-1.5">Nueva Contrasena</label>
            <input
              id="new_password"
              name="new_password"
              type="password"
          ...
          <div>
            <label htmlFor="re_new_password" className="block text-sm font-medium text-gray-300 mb-1.5">Confirmar Nueva Contrasena</label>
            <input
              id="re_new_password"
