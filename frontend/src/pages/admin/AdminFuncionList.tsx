  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          onClick={() => navigate("/admin/funciones/create")}
              ...
              {funciones.map((f: Funcion) => (
                <tr key={f.id} className="hover:bg-gray-700/30">
                  ...
                  <td className="px-4 py-3 text-right">
                    <button onClick={() => navigate(`/admin/funciones/${f.id}/edit`)} className="px-3 py-1 text-xs text-blue-400 hover:text-blue-300 mr-2">Editar</button>
