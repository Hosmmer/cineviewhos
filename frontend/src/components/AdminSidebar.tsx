...
const links = [
  ...
  { to: '/admin/genres', label: 'Genres', icon: 'M7 7h-1a2 2 0 00-2 2v9a2 2 0 002 2h1M7 7V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10M17 7h1a2 2 0 012 2v9a2 2 0 01-2 2h-1M17 7v12' },
]
